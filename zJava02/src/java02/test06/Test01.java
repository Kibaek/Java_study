...
import java.util.Properties; // key=value로 나누워지는 저장소이다. // 저정할때는 put, 가져올때는 value
...
public class Test01 {
  ...
  public void init() throws Exception {
    ...
    Set keySet = props.keySet(); // key와 value값을 구별하기 위함이다.
    ...
    for (Object key : keySet) {
      classname = (String)props.get(key); // 키값을 클래스 네임으로 바꾸고,
