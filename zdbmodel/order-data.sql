...
/*
 * 문제 : 위에 결과를 출력할 때 아이디와 이름의 라벨명(alias)을 id, name으로 바꾸어라.
 * 컬럼명 as 별명
 * 컬럼명 별명 <=== as 생략가능
 * 컬럼명 (as) 별명
 */
...
values('애플','wwww.apple.com','100-1001');

insert into MAKERS(MKNAME,HOME,TEL)
values('삼성','wwww.samsung.com','100-1002');

insert into MAKERS(MKNAME,HOME,TEL)
values('LG','wwww.lg.com','100-1003');
 
insert into MAKERS(MKNAME,HOME,TEL)
values('IBM','wwww.ibm.com','100-1004');
 
insert into MAKERS(MKNAME,HOME,TEL)
values('인텔','wwww.intel.com','100-1005');
 
insert into MAKERS(MKNAME,HOME,TEL)
values('구글','wwww.google.com','100-1006');
